...
<section class="section ivory"><div class="wrap"><div class="story-grid"><img src="{scene('assets/media/group-photo-front-building.webp',1400)}" alt="The team in front of the building in Veenendaal"><img src="{scene('assets/media/building-front.jpg',800)}" alt="Company building"><img src="{scene('assets/media/magazijn5.webp',800)}" alt="Warehouse logistics"></div></div></section>
{newsletter()}'''
    return simple_page('about.html', 'About us', 'Pegasus Depot is the direct-to-customer store of a Dutch vehicle ventilation manufacturer: 20+ years, 42 countries, stock in Veenendaal.', body, 'assets/media/group-photo-front-building.webp')
...
def page_contact():
    body = f'''
<section class="page-hero" style="min-height:340px"><img class="bg" src="{scene('assets/media/building-front.jpg',1800)}" alt=""><div class="wrap"><div class="crumbs"><a href="index.html">Home</a> / <span>Contact</span></div><div class="eyebrow">Contact</div><h1 class="h1">Talk to an engineer, not a bot.</h1><p class="lead">Cut-out sizes, 12V or 24V, how many fans for a 7-metre body: ask us. We answer within 24 hours on working days, usually much faster.</p></div></section>
...
<h3 class="h3">Shipping</h3><p class="lead" style="margin:10px 0 22px">Orders placed before 15:00 CET on working days ship the same day from our warehouse in Veenendaal, the Netherlands. Netherlands and Belgium: next working day. Germany, France, Austria, Denmark: 2 to 3 working days. Rest of EU: 3 to 5 working days. UK, Switzerland, Norway: 4 to 7 working days, duties may apply.</p>
